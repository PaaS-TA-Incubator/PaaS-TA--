    ...
    UI.addClass({
        ...
        return function () {
            ...
            this.setData = function (_data) {
                ...
                //$(this).attr("data-ax5grid-selected",false);
                this.repaint(true);
    ...
    var moveFocus = function moveFocus(_position) {
        ...
        var focus = {
            ...
            "LR": function LR(_dx) {
                ...
                console.log("moveFocus-LR: ");

                return moveResult;
            },
            "INDEX": function INDEX(_dindex) {
                // console.log("moveFocus: " + _position);
                var moveResult = true,
                    focusedColumn = void 0,
                    originalColumn = void 0,
                    while_i = void 0;
                ...
                this.focusedColumn[focusedColumn.dindex + "_" + focusedColumn.colIndex + "_" + focusedColumn.rowIndex] = focusedColumn;
                this.$.panel[focusedColumn.panelName].find('[data-ax5grid-tr-data-index="' + focusedColumn.dindex + '"]').find('[data-ax5grid-column-rowindex="' + focusedColumn.rowIndex + '"][data-ax5grid-column-colindex="' + focusedColumn.colIndex + '"]').attr('data-ax5grid-column-focused', "true");
                // console.log("moveFocus-INDEX: "+ _position);
                return moveResult;
            }
        };
        ...
        if (_position in processor) {
            // console.log("processor: " + (processor[_position].call(this)) );
            return processor[_position].call(this);
        } else {
            // console.log("processor2: " +( processor["position"].call(this, _position)) );
...
(function () {
    ...
    var initData = function initData(_list) {
        ...
        var i = 0,
            ...
            //lineNumber = 0;
            lineNumber = 0;
        if(this.page && this.page.currentPage && this.page.pageSize){
            lineNumber = U.number(this.xvar.virtualPaintStartRowIndex + this.page.currentPage * this.page.pageSize);
        }
...
(function () {
    ...
    var onclickPageMove = function onclickPageMove(_act) {
        var callback = function callback(_pageNo) {
            if (this.page && this.page.currentPage != _pageNo) {
    ...
    var navigationUpdate = function navigationUpdate() {
        ...
        if (this.page) {
            var page = {
                ...
                navigationItemCount : this.page.navigationItemCount || this.config.page.navigationItemCount,
                pageSize: this.page.pageSize,
                totalElements: this.page.totalElements,
                totalPages: this.page.totalPages,
                firstIcon: this.config.page.firstIcon || "[처음]",
                prevIcon: this.config.page.prevIcon || "«",
                nextIcon: this.config.page.nextIcon || "»",
                lastIcon: this.config.page.lastIcon || "[끝]"
            };
            //var navigationItemCount = this.config.page.navigationItemCount;
            var navigationItemCount = page.navigationItemCount;
